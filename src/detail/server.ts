...
// Lexicon JSON HTTP mirror removed: the schemas now live in
// kiesel-app/facts and are resolvable via the spec-canonical DNS TXT +
// com.atproto.lexicon.schema record on the publisher's PDS. The labeler
// is just a consumer / producer.
